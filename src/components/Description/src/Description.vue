  ...
  export default defineComponent({
    ...
    setup(props, { slots, emit }) {
      ...
      function renderItem() {
        ...
        return unref(schema)
          .map((item) => {
            const { render, field, span, show, contentMinWidth, contentStyle, type, ellipsis } =
              item;
            ...
            function handleClick(item) {
              emit('click', { ...item, value: getContent() });
            }
              ...
              >
                {() => {
                  ...
                  if (type === 'link') {
                    ...
                    return (
                      <div style={styleLink} onClick={handleClick.bind(null, item)}>
                        {getContent()}
                      </div>
                    );
                  }
                  return (
                    <div style={style} title={ellipsis ? getContent() : ''}>
                      {getContent()}
                    </div>
                  );
                }}
