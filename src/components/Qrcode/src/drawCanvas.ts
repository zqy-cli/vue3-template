import { toCanvas } from '../脚手架/vue3-template/src/components/Qrcode/src/Qrcode.vue';
import type { QRCodeRenderersOptions } from '../脚手架/vue3-template/src/components/Qrcode/src/Qrcode.vue';
